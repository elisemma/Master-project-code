...
def fit_peaks(spectrumName, position):
    ...
    # sp.isotopes = ['97ZR']
    sp.isotopes = ['87ZR', '87NB', '87Y', '87Ym', '89NB', '89NBm', '89Ym', '89ZR', '90NB', '90Ym', '91NBm',  '92NBm', '95NBm', '24NA', '40K', '96NB', '95ZR', '95NB', '97NB', '97ZR']
    # sp.isotopes = ['86Y', '86Ym']

    sp.fit_config = {'SNR_min':3.6, 'dE_511':9.0}
