...
def fit_peaks(spectrumName, position):
    ...
    sp.isotopes = ['87NB', '87Y', '87Ym', '89NB', '89NBm', '89ZR', '90NB', '90Ym', '90Y', '91NBm',  '92NBm', '96NB', '24NA', '40K', '95ZR', '95NB', '96NB']
...
if __name__ == '__main__':
    ...
    fit_peaks('CZ120317_Zr05_10cm_30MeV', '10cm') #Date: 02/13/2017 15:07
