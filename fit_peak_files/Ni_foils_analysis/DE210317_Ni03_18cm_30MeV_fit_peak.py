...
def fit_peaks(spectrumName, position):
    ...
    sp.isotopes = ['52MN', '54MN', '59FE', '55CO', '56CO', '57CO', '58CO', '58COm', '60CO','56NI', '57NI', '65NI', '61CU', '64CU']
...
if __name__ == '__main__':
    ...
    #Ni03:
    fit_peaks('DE210317_Ni03_18cm_30MeV', '18cm') #Date: 03/20/2017 18:27:32, $MEAS_TIM: 43433 43449
