...
plt.plot(E_86Sr_p_n_86Y_Uddin, Yield_86Sr_p_n_86Y_Uddin/0.0036 , label = r'$^{86}$Sr(p,n)$^{86}$Y, Uddin (2025)', color = colors[i], linestyle = linestyles[i], linewidth=linewidths[i])
i += 1
plt.plot(E_86Sr_d_2n_86Y_Uddin, Yield_86Sr_d_2n_86Y_Uddin/0.0036 , label = r'$^{86}$Sr(d,2n)$^{86}$Y, Uddin (2025)', color = colors[i], linestyle = linestyles[i], linewidth=linewidths[i])
