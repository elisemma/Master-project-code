...
def calibration_15cm():
    ...
    sp_Ba133 = ci.Spectrum('/Users/elisemma/Library/CloudStorage/OneDrive-Personal/Dokumenter/Master/FilerFraAndrew/ExtraCalibrationData/calibration/Ba133/new-gain/BD172501_15cm.Spe')
    sp_Ba133.isotopes = ['133BA'] 
    # sp_Ba133.plot()

    sp_Co56 = ci.Spectrum('/Users/elisemma/Library/CloudStorage/OneDrive-Personal/Dokumenter/Master/FilerFraAndrew/ExtraCalibrationData/calibration/Co56/new-gain/BX170102_15cm.Spe')
    sp_Co56.isotopes = ['56CO'] 
    # sp_Co56.plot()

    sp_Cs137 = ci.Spectrum('/Users/elisemma/Library/CloudStorage/OneDrive-Personal/Dokumenter/Master/FilerFraAndrew/ExtraCalibrationData/calibration/Cs137/new-gain/BI172501_15cm.Spe')
    sp_Cs137.isotopes = ['137CS'] 
    # sp_Cs137_2.plot()

    sp_Eu152 = ci.Spectrum('/Users/elisemma/Library/CloudStorage/OneDrive-Personal/Dokumenter/Master/FilerFraAndrew/ExtraCalibrationData/calibration/Eu152/new-gain/AX172401_15cm.Spe')
    sp_Eu152.isotopes = ['152EU']
    # sp_Eu152.plot()
...
def calibration_18cm():
    ...
    sp_Co56 = ci.Spectrum('/Users/elisemma/Library/CloudStorage/OneDrive-Personal/Dokumenter/Master/FilerFraAndrew/2017_Feb_Zr/calibration/Co56_190217_18cm.Spe')
    sp_Co56.isotopes = ['56CO'] 
    # sp_Co56.plot()
    ...
    # fig = plt.figure()
    sp_Eu152.plot()  
    # pl.dump(fig,open('/Users/elisemma/Library/CloudStorage/OneDrive-Personal/Dokumenter/Master/FilerFraAndrew/2017_Feb_Zr/calibration/152Eu18cm.pickle','wb'))  
...
def calibration_22cm():
    ...
    sp_Ba133 = ci.Spectrum('/Users/elisemma/Library/CloudStorage/OneDrive-Personal/Dokumenter/Master/FilerFraAndrew/ExtraCalibrationData/calibration/Ba133/new-gain/BL172501_22cm.Spe')
    sp_Ba133.isotopes = ['133BA'] 
    # sp_Ba133.plot()

    sp_Co56 = ci.Spectrum('/Users/elisemma/Library/CloudStorage/OneDrive-Personal/Dokumenter/Master/FilerFraAndrew/ExtraCalibrationData/calibration/Co56/new-gain/CI170302_22cm.Spe')
    sp_Co56.isotopes = ['56CO'] 
    # sp_Co56.plot()

    sp_Cs137 = ci.Spectrum('/Users/elisemma/Library/CloudStorage/OneDrive-Personal/Dokumenter/Master/FilerFraAndrew/ExtraCalibrationData/calibration/Cs137/new-gain/BJ172501_22cm.Spe')
    sp_Cs137.isotopes = ['137CS'] 
    # sp_Cs137_2.plot()

    sp_Eu152 = ci.Spectrum('/Users/elisemma/Library/CloudStorage/OneDrive-Personal/Dokumenter/Master/FilerFraAndrew/ExtraCalibrationData/calibration/Eu152/new-gain/AY172401_22cm.Spe')
    sp_Eu152.isotopes = ['152EU']
    # sp_Eu152.plot()
...
def calibration_50cm():
    ...
    sp_Co56 = ci.Spectrum('/Users/elisemma/Library/CloudStorage/OneDrive-Personal/Dokumenter/Master/FilerFraAndrew/2017_Feb_Zr/calibration/Co56_140317_50cm.Spe')
    sp_Co56.isotopes = ['56CO'] 
    # sp_Co56.plot()
    ...
    cb.calibrate([sp_Ba133, sp_Cs137, sp_Eu152, sp_Co56], sources=sources)
    cb.plot(show=False, saveas = './MyGeneratedFiles/Calibration/Figures/calibration_plots_50cm.pdf')
