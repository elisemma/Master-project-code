...
df_87Y_ind = pd.read_csv('../Calculated_xs/Zr_dx_87Y_ground_state_Independent_xs.csv')
...
def plot_xs(reaction_product, state, Z, A, foil_list, title, xs_type, exfor_manuel=False, write_csv=False, save_fig=False, use_R_to_calc_xs=True):
    ...
    if write_csv == True:
        ...
        with open(csv_file_path, 'w', newline='') as csv_file:
            ...
            for row in df_87Y_ind.itertuples():
    ...
    plt.errorbar(df_87Y_ind['Energy'], df_87Y_ind['xs'], xerr=[df_87Y_ind['Energy_min_unc'], df_87Y_ind['Energy_plus_unc']], yerr=df_87Y_ind['xs_unc'], marker='D', markersize=4, linewidth=2, linestyle='', color='hotpink', label='This work')
...
plot_xs('87Y', 'ground_state', 39, 87, ['Zr01', 'Zr02', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{87}$Y - ', 'Independent', save_fig=True, write_csv=False, exfor_manuel=True)
