...
df_57Ni_cum = pd.read_csv('../Calculated_xs/Ni_dx_57Ni_ground_state_Cumulative_xs.csv')
df_57Ni_cum = df_57Ni_cum[::-1]
...
def plot_xs(reaction_product, state, Z, A, foil_list, title, xs_type, exfor_manuel=False, write_csv=False, save_fig=False, use_R_to_calc_xs=True):
    ...
    if write_csv == True:
        ...
        with open(csv_file_path, 'w', newline='') as csv_file:
            ...
            for row in df_57Ni_cum.itertuples():
    ...
    plt.errorbar(df_57Ni_cum['Energy'], df_57Ni_cum['xs'], xerr=[df_57Ni_cum['Energy_min_unc'], df_57Ni_cum['Energy_plus_unc']], yerr=df_57Ni_cum['xs_unc'], marker='D', markersize=4, linewidth=2, linestyle='', color='hotpink', label='This work')
