...
df_87Y_cum = pd.read_csv('../Calculated_xs/Zr_dx_87Y_ground_state_Cumulative_xs.csv')
...
def get_talys_data(filename, foil_name):
    ...
    xs_feeding1 = [0]+list(xs_feeding1)

    xs_list = [x+y+z for x,y,z in zip(xs_ind, xs_feeding, xs_feeding1)]
    print(xs_list)
...
def plot_xs(reaction_product, state, Z, A, foil_list, title, xs_type, exfor_manuel=False, write_csv=False, save_fig=False, use_R_to_calc_xs=True):
    ...
    if write_csv == True:
        ...
        with open(csv_file_path, 'w', newline='') as csv_file:
            ...
            for row in df_87Y_cum.itertuples():
    ...
    plt.errorbar(df_87Y_cum['Energy'], df_87Y_cum['xs'], xerr=[df_87Y_cum['Energy_min_unc'], df_87Y_cum['Energy_plus_unc']], yerr=df_87Y_cum['xs_unc'], marker='D', markersize=4, linewidth=2, linestyle='', color='hotpink', label='This work')
...
plot_xs('87Y', 'ground_state', 39, 87, ['Zr01', 'Zr02', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{87}$Y - ', 'Cumulative', save_fig=True, write_csv=False, exfor_manuel=True)
