...
df_86Ym_ind = pd.read_csv('../Calculated_xs/Zr_dx_86Ym_isomeric_state_Independent_xs.csv')
...
def plot_xs(reaction_product, state, Z, A, foil_list, title, xs_type, exfor_manuel=False, write_csv=False, save_fig=False, use_R_to_calc_xs=True):
    ...
    if write_csv == True:
        ...
        with open(csv_file_path, 'w', newline='') as csv_file:
            ...
            for row in df_86Ym_ind.itertuples():
    ...
    #Get data from alice
    E_alice, xs_alice = get_alice_data(target_material, Z, A, 7)
    E_alice = [0]+E_alice
    ...
    plt.errorbar(df_86Ym_ind['Energy'], df_86Ym_ind['xs'], xerr=[df_86Ym_ind['Energy_min_unc'], df_86Ym_ind['Energy_plus_unc']], yerr=df_86Ym_ind['xs_unc'], marker='D', markersize=4, linewidth=2, linestyle='', color='hotpink', label='This work')
...
plot_xs('86Ym', 'isomeric_state', 39, 86, ['Zr06', 'Zr07', 'Zr08', 'Zr09'], r'$^{nat}$Zr(d,x)$^{86m}$Y - ', 'Independent', save_fig=True, write_csv=False, exfor_manuel=False)
