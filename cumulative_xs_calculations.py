...
df_87Yg_ind = pd.read_csv('./Calculated_xs/Zr_dx_87Y_ground_state_Independent_xs.csv')
df_87Ym_cum = pd.read_csv('./Calculated_xs/Zr_dx_87Ym_isomeric_state_Cumulative_xs.csv')
...
# # Cumulative xs for 87Y:
# df_87Y_cum = pd.DataFrame()

# for row1, row2 in zip(df_87Ym_cum.itertuples(), df_87Yg_ind.itertuples()):
...
#     df_87Y_cum = df_87Y_cum._append(new_row, ignore_index=True)
...
def plot_xs(reaction_product, state, Z, A, foil_list, title, xs_type, exfor_manuel=False, write_csv=False, save_fig=False, use_R_to_calc_xs=True):
    ...
    plt.plot(energy_array, empire_spline(energy_array), linewidth=1, color='darkturquoise', linestyle='-.', label='EMPIRE 3.2.3')
    # plt.plot(energy_array, splev(energy_array, talys_spline)*1.1, linewidth=2, color='cornflowerblue', linestyle=':', label='test.')#dette skal bli tendl
    ...
    plt.errorbar(df_88Zr_cum['Energy'], df_88Zr_cum['xs'], xerr=[df_88Zr_cum['Energy_min_unc'], df_88Zr_cum['Energy_plus_unc']], yerr=df_88Zr_cum['xs_unc'], marker='D', markersize=5, linewidth=3, linestyle='', color='hotpink', label='This work')
    # plt.errorbar(df_88Zr_cum['Energy'], df_88Zr_cum['xs'], xerr=[df_88Zr_cum['Energy_min_unc'], df_88Zr_cum['Energy_plus_unc']], yerr=df_88Zr_cum['xs_unc'], marker='D', markersize=5, linewidth=3, linestyle='', color='hotpink', label='This work')
    ...
    plt.xlim(0,50)
    if save_fig==True:
        plt.savefig(f'./Figures/xs_plots/{target_material}/{target_material}_dx_{reaction_product}_{state}_{xs_type}.pdf', dpi=600)
    plt.show()
...
# plot_xs('86Y', 'ground_state', 39, 86, ['Zr06', 'Zr07', 'Zr08', 'Zr09'], r'$^{nat}$Zr(d,x)$^{86}$Y - ', 'Cumulative', save_fig=False)

# plot_xs('87Y', 'ground_state', 39, 87, ['Zr01', 'Zr02', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{87}$Y - ', 'Independent', save_fig=False, write_csv=False, exfor_manuel=False)
# plot_xs('87Ym', 'isomeric_state', 39, 87, ['Zr01', 'Zr02', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{87m}$Y - ', 'Cumulative', save_fig=False, write_csv=False, exfor_manuel=False)
# plot_xs('87Y', 'ground_state', 39, 87, ['Zr01', 'Zr02', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{87}$Y - ', 'Cumulative', save_fig=False, write_csv=False, exfor_manuel=False)
# plot_xs('87ZR', 'ground_state', 40, 87, ['Zr01', 'Zr02', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{87}$Zr - ', 'Independent', save_fig=False)


# plot_xs('88Y', 'ground_state', 39, 88, ['Zr01', 'Zr02', 'Zr03', 'Zr04'], r'$^{nat}$Zr(d,x)$^{88}$Y - ', 'Cumulative', save_fig=False, write_csv=False, exfor_manuel=False)
# plot_xs('88Y', 'ground_state', 39, 88, ['Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{88}$Y - ', 'Independent', save_fig=False, write_csv=False, exfor_manuel=False)
# plot_xs('88ZR', 'ground_state', 40, 88, ['Zr06', 'Zr07'], r'$^{nat}$Zr(d,x)$^{88}$Zr - ', 'Independent', save_fig=False, write_csv=False)
plot_xs('88ZR', 'ground_state', 40, 88, ['Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{88}$Zr - ', 'Cumulative', save_fig=False, write_csv=False, exfor_manuel=False)
# plot_xs('88NB', 'ground_state', 41, 88, ['Zr06', 'Zr07'], r'$^{nat}$Zr(d,x)$^{88}$Nb - ', 'Independent', save_fig=False, write_csv=False)

# plot_xs('89NBm', 'isomeric_state', 41, 89, ['Zr01', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{89m}$Nb - ', 'Independent', save_fig=False, write_csv=False)
# # plot_xs('89NB', 'ground_state', 41, 89, ['Zr01', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{89}$Nb - ', 'Cumulative', save_fig=False, write_csv=False)
# plot_xs('89ZR', 'ground_state', 40, 89, ['Zr01', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{89}$Zr - ', 'Independent', save_fig=False, write_csv=False)
# plot_xs('89ZR', 'ground_state', 40, 89, ['Zr02', 'Zr03', 'Zr04'], r'$^{nat}$Zr(d,x)$^{89}$Zr - ', 'Cumulative', save_fig=False, write_csv=False)


# plot_xs('90NB', 'ground_state', 41, 90, ['Zr01', 'Zr02', 'Zr03', 'Zr04', 'Zr05', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{90}$Nb - ', 'Independent', save_fig=False, write_csv=False)

# plot_xs('90Ym', 'isomeric_state', 39, 90, ['Zr01', 'Zr03', 'Zr06', 'Zr07', 'Zr08', 'Zr10'], r'$^{nat}$Zr(d,x)$^{90m}$Y - ', 'Cumulative', save_fig=False, write_csv=False)

# plot_xs('92NBm', 'isomeric_state', 41, 92, ['Zr01', 'Zr02', 'Zr03', 'Zr04', 'Zr05', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{92m}$Nb - ', 'Independent', exfor_manuel=False, save_fig=False, write_csv=False)

# plot_xs('95ZR', 'ground_state', 40, 95, ['Zr01', 'Zr02', 'Zr03', 'Zr04', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{95}$Zr - ', 'Cumulative', save_fig=False, write_csv=False)
# plot_xs('95NBm', 'isomeric_state', 41, 95, ['Zr01', 'Zr02', 'Zr03', 'Zr04', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{95m}$Nb - ', 'Independent', save_fig=False, exfor_manuel=False,)
# plot_xs('95NB', 'ground_state', 41, 95, ['Zr01', 'Zr02', 'Zr03', 'Zr04', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{95}$Nb - ', 'Independent', save_fig=False, write_csv=False)
