...
df_AXZR05 = pd.read_csv(path_Zr+file_AXZR05)
...
df_concat_Zr = pd.concat((df_AXZR05, df_BAZR01, df_BIZR04, df_BPZR01, df_BRZR02, df_BSZR05, df_BTZR03, df_BXZR01, df_CHZR03, df_CRZR04, df_BFZR01, df_BGZR02, df_BHZR03, df_BOZR04, df_CYZR02, df_CZZR05, df_AAZR01, df_ABZR09, df_ABZR08, df_ACZR07, df_AEZR06, df_AFZR10, df_AGZR09, df_AHZR08, df_AIZR07, df_AJZR06, df_AKZR06, df_ALZR06, df_AMZR06, df_ANZR07, df_AOZR07, df_APZR08, df_AQZR09, df_ARZR10, df_ASZR07, df_AUZR08, df_AVZR09, df_AWZR10, df_BJZR06, df_BKZR07, df_BLZR08, df_BMZR09, df_BNZR10, df_BQZR06, df_CAZR06, df_CBZR07, df_CDZR08, df_CNZR09, df_CVZR10, df_CVZR10), axis = 0)
# df_concat_Zr = pd.concat((df_AXZR05, df_BAZR01, df_BIZR04, df_BPZR01, df_BRZR02, df_BSZR05, df_BTZR03, df_BXZR01, df_CHZR03, df_CRZR04, df_BFZR01, df_BGZR02, df_BHZR03, df_BOZR04, df_CYZR02, df_CZZR05, df_AAZR01, df_ABZR09, df_ABZR08, df_ACZR07, df_AEZR06, df_AFZR10, df_AGZR09, df_AHZR08, df_AKZR06, df_ALZR06, df_AMZR06, df_ANZR07, df_AOZR07, df_APZR08, df_AQZR09, df_ARZR10, df_ASZR07, df_AUZR08, df_AVZR09, df_AWZR10, df_BJZR06, df_BKZR07, df_BLZR08, df_BMZR09, df_BNZR10, df_BQZR06, df_CAZR06, df_CBZR07, df_CDZR08, df_CNZR09, df_CVZR10, df_CVZR10), axis = 0) #Tatt bort 88Nb
# df_concat_Zr = pd.concat((df_BXZR01, df_CYZR02, df_CAZR06, df_CBZR07, df_CDZR08, df_CNZR09, df_CVZR10, df_CVZR10), axis = 0) #after 87Ym has decayed out
# df_concat_Zr = pd.concat((df_BPZR01, df_BXZR01, df_BRZR02, df_CYZR02, df_AKZR06, df_ALZR06, df_AMZR06, df_ANZR07, df_AOZR07, df_APZR08, df_AQZR09, df_ARZR10, df_ASZR07, df_AUZR08, df_AVZR09, df_AWZR10, df_BJZR06, df_BKZR07, df_BLZR08, df_BMZR09, df_BNZR10, df_BQZR06, df_CAZR06, df_CBZR07, df_CDZR08, df_CNZR09, df_CVZR10, df_CVZR10), axis = 0) #after 87Zr has decayed out (5-6 half lives)
# df_concat_Zr = pd.concat((df_BPZR01, df_BXZR01, df_BRZR02, df_CYZR02, df_ASZR07, df_BJZR06, df_BKZR07, df_BLZR08, df_BMZR09, df_BNZR10, df_BQZR06, df_CAZR06, df_CBZR07, df_CDZR08, df_CNZR09, df_CVZR10, df_CVZR10), axis = 0) #after 87Zr has decayed out (10 half lives)

# df_concat_Zr = pd.concat((df_BIZR04, df_BTZR03, df_CHZR03, df_CRZR04, df_BXZR01, df_BHZR03, df_BOZR04, df_CYZR02, df_BJZR06, df_BKZR07, df_BLZR08, df_BMZR09, df_BNZR10, df_BQZR06, df_CAZR06, df_CBZR07, df_CDZR08, df_CNZR09, df_CVZR10, df_CVZR10), axis = 0) #89Nb has decayed
...
df_concat_Zr['filename'] = df_concat_Zr['filename'].str.replace('Zr6', 'Zr06')
df_concat_Zr['filename'] = df_concat_Zr['filename'].str.replace('Zr7', 'Zr07')
df_concat_Zr['filename'] = df_concat_Zr['filename'].str.replace('Zr8', 'Zr08')
df_concat_Zr['filename'] = df_concat_Zr['filename'].str.replace('Zr9', 'Zr09')
df_concat_Zr.to_csv(path_Zr+file_concat_Zr)
pd.set_option('display.max_rows', None)
df_96NB=df_concat_Zr[df_concat_Zr['isotope']=='96NB']



# Get unique energy values and sort them
sorted_unique_energies = df_96NB['energy'].drop_duplicates().sort_values()
...
def fit_prod_rate(isotope_list, isotope_chain_parent, foil, path, file, stack, plot=False):
    ...
    if plot==True:
        # dc.plot(saveas='./Figures/decay_chain_86Ym_86Y_Zr08.pdf', dpi=1000)
        dc.plot()
...
# isotope_list_list_Zr08 = [['88ZR', '88Y']]
# isotope_chain_parent_list_Zr08 = ['88ZR']

# isotope_list_list_Zr09 = [['88ZR', '88Y']]
# isotope_chain_parent_list_Zr09 = ['88ZR']

# isotope_list_list_Zr10 = [['88ZR', '88Y']]
# isotope_chain_parent_list_Zr10 = ['88ZR']
...
# # isotope_list_list_Zr02 = [['90Ym']]
# # isotope_chain_parent_list_Zr02 = ['90Ym']
...
# # isotope_list_list_Zr09 = [['90Ym']]
# # isotope_chain_parent_list_Zr09 = ['90Ym']
...
#Ikke funnet:
# isotope_list_list_Zr03 = [['91NBm']]
# isotope_chain_parent_list_Zr03 = ['91NBm']

# isotope_list_list_Zr04 = [['91NBm']]
# isotope_chain_parent_list_Zr04 = ['91NBm']

# isotope_list_list_Zr06 = [['91NBm']]
# isotope_chain_parent_list_Zr06 = ['91NBm']

# isotope_list_list_Zr07 = [['91NBm']]
# isotope_chain_parent_list_Zr07 = ['91NBm']

# isotope_list_list_Zr08 = [['91NBm']]
# isotope_chain_parent_list_Zr08 = ['91NBm']

# isotope_list_list_Zr09 = [['91NBm']]
# isotope_chain_parent_list_Zr09 = ['91NBm']

# isotope_list_list_Zr10 = [['91NBm']]
# isotope_chain_parent_list_Zr10 = ['91NBm']



# isotope_list_list_Zr01 = [['92NBm']]
# isotope_chain_parent_list_Zr01 = ['92NBm']

# isotope_list_list_Zr02 = [['92NBm']]
# isotope_chain_parent_list_Zr02 = ['92NBm']

# isotope_list_list_Zr03 = [['92NBm']]
# isotope_chain_parent_list_Zr03 = ['92NBm']

# isotope_list_list_Zr04 = [['92NBm']]
# isotope_chain_parent_list_Zr04 = ['92NBm']

# isotope_list_list_Zr05 = [['92NBm']]
# isotope_chain_parent_list_Zr05 = ['92NBm']

# isotope_list_list_Zr06 = [['92NBm']]
# isotope_chain_parent_list_Zr06 = ['92NBm']

# isotope_list_list_Zr07 = [['92NBm']]
# isotope_chain_parent_list_Zr07 = ['92NBm']

# isotope_list_list_Zr08 = [['92NBm']]
# isotope_chain_parent_list_Zr08 = ['92NBm']

# isotope_list_list_Zr09 = [['92NBm']]
# isotope_chain_parent_list_Zr09 = ['92NBm']

# isotope_list_list_Zr10 = [['92NBm']]
# isotope_chain_parent_list_Zr10 = ['92NBm']
...
# isotope_list_list_Zr01 = [['88Y'], ['89NBm', '89NB', '89ZR'], ['90Ym'], ['90NB'], ['92NBm'], ['95ZR', '95NBm', '95NB'], ['96NB']]
# isotope_chain_parent_list_Zr01 = ['88Y', '89NBm', '90Ym', '90NB', '92NBm', '95ZR', '96NB']

# isotope_list_list_Zr02 = [['88Y'], ['89ZR'], ['90NB'], ['92NBm'], ['95ZR', '95NBm', '95NB'], ['96NB']]
# isotope_chain_parent_list_Zr02 = ['88Y', '89ZR', '90NB', '92NBm', '95ZR', '96NB']

# isotope_list_list_Zr03 = [['88Y'], ['89ZR'], ['90Ym'], ['90NB'], ['92NBm'], ['95ZR', '95NBm', '95NB'], ['96NB']]
# isotope_chain_parent_list_Zr03 = ['88Y', '89ZR', '90Ym', '90NB', '92NBm', '95ZR', '96NB']

# isotope_list_list_Zr04 = [['88Y'], ['89ZR'], ['90NB'], ['92NBm'], ['95ZR', '95NBm', '95NB'], ['96NB']]
# isotope_chain_parent_list_Zr04 = ['88Y', '89ZR', '90NB', '92NBm', '95ZR', '96NB']

# isotope_list_list_Zr05 = [['90NB'], ['92NBm']]
# isotope_chain_parent_list_Zr05 = ['90NB', '92NBm']

# isotope_list_list_Zr06 = [['86Ym', '86Y'], ['88NB', '88ZR', '88Y'], ['89NBm', '89NB', '89ZR'], ['90Ym'], ['90NB'], ['92NBm'], ['95ZR', '95NBm', '95NB'], ['96NB']]
# isotope_chain_parent_list_Zr06 = ['86Ym', '88NB', '89NBm', '90Ym', '90NB', '92NBm', '95ZR', '96NB']

# isotope_list_list_Zr07 = [['86Ym', '86Y'], ['88NB', '88ZR', '88Y'], ['89NBm', '89NB', '89ZR'], ['90Ym'], ['90NB'], ['92NBm'], ['95ZR', '95NBm', '95NB'], ['96NB']]
# isotope_chain_parent_list_Zr07 = ['86Ym', '88NB', '89NBm', '90Ym', '90NB', '92NBm', '95ZR', '96NB']

# isotope_list_list_Zr08 = [['86Ym', '86Y'], ['88ZR', '88Y'], ['89NBm', '89NB', '89ZR'], ['90Ym'], ['90NB'], ['92NBm'], ['95ZR', '95NBm', '95NB'], ['96NB']]
# isotope_chain_parent_list_Zr08 = ['86Ym', '88ZR', '89NBm', '90Ym', '90NB', '92NBm', '95ZR', '96NB']

# isotope_list_list_Zr09 = [['86Ym', '86Y'], ['88ZR', '88Y'], ['89NBm', '89NB', '89ZR'], ['90NB'], ['92NBm'], ['95ZR', '95NBm', '95NB'], ['96NB']]
# isotope_chain_parent_list_Zr09 = ['86Ym', '88ZR', '89NBm', '90NB', '92NBm', '95ZR', '96NB']

# isotope_list_list_Zr10 = [['88ZR', '88Y'], ['89NBm', '89NB', '89ZR'], ['90Ym'], ['90NB'], ['92NBm'], ['95ZR', '95NBm', '95NB'], ['96NB']]
# isotope_chain_parent_list_Zr10 = ['88ZR', '89NBm', '90Ym', '90NB', '92NBm', '95ZR', '96NB']
...
# isotope_list_list_Zr01 = [['87ZR', '87Ym', '87Y']]
# isotope_chain_parent_list_Zr01 = ['87ZR']

# isotope_list_list_Zr02 = [['87ZR', '87Ym', '87Y']]
# isotope_chain_parent_list_Zr02 = ['87ZR']

# isotope_list_list_Zr06 = [['87ZR', '87Ym', '87Y']]
# isotope_chain_parent_list_Zr06 = ['87ZR']

# isotope_list_list_Zr07 = [['87ZR', '87Ym', '87Y']]
# isotope_chain_parent_list_Zr07 = ['87ZR']

# isotope_list_list_Zr08 = [['87ZR', '87Ym', '87Y']]
# isotope_chain_parent_list_Zr08 = ['87ZR']

# isotope_list_list_Zr09 = [['87ZR', '87Ym', '87Y']]
# isotope_chain_parent_list_Zr09 = ['87ZR']

# isotope_list_list_Zr10 = [['87ZR', '87Ym', '87Y']]
# isotope_chain_parent_list_Zr10 = ['87ZR']



# isotope_list_list_Zr01 = [['87ZR', '87Ym']]
# isotope_chain_parent_list_Zr01 = ['87ZR']

# isotope_list_list_Zr02 = [['87ZR', '87Ym']]
# isotope_chain_parent_list_Zr02 = ['87ZR']

# isotope_list_list_Zr06 = [['87ZR', '87Ym']]
# isotope_chain_parent_list_Zr06 = ['87ZR']

# isotope_list_list_Zr07 = [['87ZR', '87Ym']]
# isotope_chain_parent_list_Zr07 = ['87ZR']

# isotope_list_list_Zr08 = [['87ZR', '87Ym']]
# isotope_chain_parent_list_Zr08 = ['87ZR']

# isotope_list_list_Zr09 = [['87ZR', '87Ym']]
# isotope_chain_parent_list_Zr09 = ['87ZR']

# isotope_list_list_Zr10 = [['87ZR', '87Ym']]
# isotope_chain_parent_list_Zr10 = ['87ZR']



# isotope_list_list_Zr01 = [['87Ym']]
# isotope_chain_parent_list_Zr01 = ['87Ym']

# isotope_list_list_Zr02 = [['87Ym']]
# isotope_chain_parent_list_Zr02 = ['87Ym']

# isotope_list_list_Zr06 = [['87Ym']]
# isotope_chain_parent_list_Zr06 = ['87Ym']

# isotope_list_list_Zr07 = [['87Ym']]
# isotope_chain_parent_list_Zr07 = ['87Ym']

# isotope_list_list_Zr08 = [['87Ym']]
# isotope_chain_parent_list_Zr08 = ['87Ym']

# isotope_list_list_Zr09 = [['87Ym']]
# isotope_chain_parent_list_Zr09 = ['87Ym']

# isotope_list_list_Zr10 = [['87Ym']]
# isotope_chain_parent_list_Zr10 = ['87Ym']
...
# isotope_list_list_Zr01 = [['89ZR']]
# isotope_chain_parent_list_Zr01 = ['89ZR']

# isotope_list_list_Zr02 = [['89ZR']]
# isotope_chain_parent_list_Zr02 = ['89ZR']

# isotope_list_list_Zr03 = [['89ZR']]
# isotope_chain_parent_list_Zr03 = ['89ZR']

# isotope_list_list_Zr04 = [['89ZR']]
# isotope_chain_parent_list_Zr04 = ['89ZR']


# isotope_list_list_Zr06 = [['89ZR']]
# isotope_chain_parent_list_Zr06 = ['89ZR']

# isotope_list_list_Zr07 = [['89ZR']]
# isotope_chain_parent_list_Zr07 = ['89ZR']

# isotope_list_list_Zr08 = [['89ZR']]
# isotope_chain_parent_list_Zr08 = ['89ZR']

# isotope_list_list_Zr09 = [['89ZR']]
# isotope_chain_parent_list_Zr09 = ['89ZR']

# isotope_list_list_Zr10 = [['89ZR']]
# isotope_chain_parent_list_Zr10 = ['89ZR']
...
# calc_prod_rates_in_foil(isotope_list_list_Zr01, isotope_chain_parent_list_Zr01, 'Zr01', '30MeV', write_to_file=False, show_plot=True)
# calc_prod_rates_in_foil(isotope_list_list_Zr02, isotope_chain_parent_list_Zr02, 'Zr02', '30MeV', write_to_file=False, show_plot=True)
# calc_prod_rates_in_foil(isotope_list_list_Zr03, isotope_chain_parent_list_Zr03, 'Zr03', '30MeV', write_to_file=False, show_plot=True)
# calc_prod_rates_in_foil(isotope_list_list_Zr04, isotope_chain_parent_list_Zr04, 'Zr04', '30MeV', write_to_file=True, show_plot=False)
# calc_prod_rates_in_foil(isotope_list_list_Zr05, isotope_chain_parent_list_Zr05, 'Zr05', '30MeV', write_to_file=True, show_plot=False)
# calc_prod_rates_in_foil(isotope_list_list_Zr06, isotope_chain_parent_list_Zr06, 'Zr06', '50MeV', write_to_file=True, show_plot=False)
# calc_prod_rates_in_foil(isotope_list_list_Zr07, isotope_chain_parent_list_Zr07, 'Zr07', '50MeV', write_to_file=True, show_plot=False)
# calc_prod_rates_in_foil(isotope_list_list_Zr08, isotope_chain_parent_list_Zr08, 'Zr08', '50MeV', write_to_file=True, show_plot=False)
# calc_prod_rates_in_foil(isotope_list_list_Zr09, isotope_chain_parent_list_Zr09, 'Zr09', '50MeV', write_to_file=True, show_plot=False)
# calc_prod_rates_in_foil(isotope_list_list_Zr10, isotope_chain_parent_list_Zr10, 'Zr10', '50MeV', write_to_file=False, show_plot=True)
