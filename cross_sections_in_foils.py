...
def plot_xs(reaction_product, state, Z, A, foil_list, title, xs_type, exfor_manuel=False, write_csv=False, save_fig=False, use_R_to_calc_xs=True):
    ...
    # for i in range(len(target_A_list)):
    #     empire_path = f'./empire_calculations/{target_material}/{target_A_list[i]}{target_material}/'
    #     if state == 'isomeric_state':
    #         product = reaction_product[:-1]
    #     else:
    #         product = reaction_product
    ...
    if exfor_manuel == False:
        ...
        for i, file_name in enumerate(files):
            ...
            plt.errorbar(energy, cross_section, xerr=energy_unc, yerr=cross_section_unc, ls='none', capsize=1, marker=markers[i], markersize=4, linewidth=1, color=grey_colors[i])
...
# plot_xs('87Ym', 'isomeric_state', 39, 87, ['Zr01', 'Zr02', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{87m}$Y - ', 'Independent', save_fig=True)
# plot_xs('87ZR', 'ground_state', 40, 87, ['Zr01', 'Zr02', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{87}$Zr - ', 'Independent', save_fig=True)
...
# plot_xs('89NBm', 'isomeric_state', 41, 89, ['Zr01', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{89m}$Nb - ', 'Independent', save_fig=True)
# # plot_xs('89NB', 'ground_state', 41, 89, ['Zr01', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{89}$Nb - ', 'Cumulative', save_fig=True)
# plot_xs('89ZR', 'ground_state', 40, 89, ['Zr01', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{89}$Zr - ', 'Independent', save_fig=True)
# plot_xs('89ZR', 'ground_state', 40, 89, ['Zr02', 'Zr03', 'Zr04'], r'$^{nat}$Zr(d,x)$^{89}$Zr - ', 'Cumulative', save_fig=True)
...
# plot_xs('92NBm', 'isomeric_state', 41, 92, ['Zr01', 'Zr02', 'Zr03', 'Zr04', 'Zr05', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{92m}$Nb - ', 'Independent', exfor_manuel=True, save_fig=True)

# plot_xs('95ZR', 'ground_state', 40, 95, ['Zr01', 'Zr02', 'Zr03', 'Zr04', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{95}$Zr - ', 'Cumulative', save_fig=True)
# plot_xs('95NBm', 'isomeric_state', 41, 95, ['Zr01', 'Zr02', 'Zr03', 'Zr04', 'Zr06', 'Zr07', 'Zr08', 'Zr09', 'Zr10'], r'$^{nat}$Zr(d,x)$^{95m}$Nb - ', 'Independent', save_fig=True, exfor_manuel=True,)
...
# def plot_xs(reaction_product, state, Z, A, foil_list, title, xs_type, write_csv=False, save_fig=False, use_R_to_calc_xs=True):
