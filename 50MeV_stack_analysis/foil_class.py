...
class Foil: 
    ...
    def assign_areal_dens_unc_percent(self):
        areal_dens_unc_dict = {'Fe01': 0.1495, 'Fe02': 0.1538, 'Fe03': 0.5548, 'Fe04': 0.2488, 'Fe05': 0.5570,
                               'Ti06': 0.7734, 'Ti08': 0.9319, 'Ti09': 0.7655, 'Ti10': 2.1443, 'Ti11': 0.1364}
    ...
    def assign_molar_mass(self):
        ...
        if self.target_material == 'Fe':
            self.molar_mass  = 55.845
            self.molar_mass_unc = 0.002
