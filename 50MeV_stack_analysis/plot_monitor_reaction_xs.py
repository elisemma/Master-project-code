...
plt.legend()
plt.xlim(0,50)
plt.savefig('/Users/elisemma/Library/CloudStorage/OneDrive-Personal/Dokumenter/Master/Master-project-code/Figures/xs_mon_50MeV_56Co.pdf', dpi=600)
plt.show()
...
plt.legend()
plt.xlim(0,50)
plt.savefig('/Users/elisemma/Library/CloudStorage/OneDrive-Personal/Dokumenter/Master/Master-project-code/Figures/xs_mon_50MeV_46Sc.pdf', dpi=600)
plt.show()
...
plt.legend()
plt.xlim(0,50)
plt.savefig('/Users/elisemma/Library/CloudStorage/OneDrive-Personal/Dokumenter/Master/Master-project-code/Figures/xs_mon_50MeV_48V.pdf', dpi=600)
plt.show()
