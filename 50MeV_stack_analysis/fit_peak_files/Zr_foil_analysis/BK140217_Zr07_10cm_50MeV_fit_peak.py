...
def fit_peaks(spectrumName, position):
    ...
    sp.isotopes = ['86Y', '87Y', '87Ym', '88Y', '89Y', '89Ym', '90Y', '90Ym', 
                   '86NB', '87NB', '88NB', '89NB', '89NBm', '90NB', '91NBm',  '92NBm', '95NB', '95NBm', '96NB',
                   '89ZR',
                   '24NA', '40K']    # sp.fit_config = {'SNR_min':3.5, 'dE_511':9.0, 'skew_fit':True}
...
if __name__ == '__main__':
    ...
    fit_peaks('BK140217_Zr07_10cm_50MeV', '10cm')