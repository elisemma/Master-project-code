...
def fit_peaks(spectrumName, position):
    ...
    cb = ci.Calibration('../../MyGeneratedFiles/Calibration/json_files/calibrationByHand_CK010317_Ti02_18cm_30MeV.json') #Not calibration for this file, but it works
    ...
    sp.isotopes = ['87Y', '87Ym', '88Y', '89Y', '89Ym', '90Y', '90Ym', 
                   '86NB', '87NB', '88NB', '89NBm', '90NB', '91NBm',  '92NBm', '95NB', '95NBm', '96NB',
                   '88ZR', '89ZR', '95ZR',
                   '24NA', '40K']
...
if __name__ == '__main__':
    ...
    fit_peaks('CN020317_Zr09_18cm_50MeV', '18cm_new')