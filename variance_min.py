...
def plot_chi2(dp_list, compartment_list, method):
    ...
    # plt.title(f'Variance minimization of compartment 4 in the 30 MeV stack using the p1-method', fontsize = 14)
    # plt.savefig('./Figures/var_min_30MeV_p1.pdf', dpi=600)
